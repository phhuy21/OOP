...
## 2. Kiến trúc và Thiết kế hướng đối tượng (OOP)
...
```text
├── docs/                           # Tài liệu thiết kế & ảnh chụp màn hình
├── skygate/                        # Mã nguồn chính dự án
│   ├── src/                        # Logic lõi Backend (C++ OOP)
│   │   ├── aircraft/               # Phân lớp và Factory của Máy bay
│   │   ├── common/                 # Các tiện ích chung, định dạng DateTime, Enums
...
├── Bai1.cpp, Bai2.cpp, Bai3.cpp    # Các bài tập thực hành bổ trợ môn học
├── README.md                       # Tài liệu hướng dẫn sử dụng dự án
└── .gitignore                      # Cấu hình loại bỏ file rác khi đẩy mã nguồn
```
